...
class ProcessAlertDigest implements ShouldQueue, ShouldBeUnique
{
    ...
    {
        return $this->subscriberId . ':' . $this->date . ':' . $this->digestType;
    }
    ...
    protected function buildDigestContent($notifications, float $engagementScore): array
    {
        ...
        $highPriority = $notifications->filter(function ($n) {
            return data_get($n->payload, 'priority') === 'critical';
        })->count();
